      ...
      >
        ...
        {isOpen && (
          <div className="flex flex-col h-full">
            ...
            <Tabs value={surface} onValueChange={(v) => switchSurface(v as L2Surface)} className="flex-1 flex flex-col overflow-hidden">
              <TabsList 
...
function SurfaceChat() {
  const [messages, setMessages] = useState([
    { role: 'assistant' as const, content: 'Hello! I\'m your cognitive assistant. I can help you understand evidence, trace decisions, and explore signals across all 14 surfaces. What would you like to know?' }
  ])
