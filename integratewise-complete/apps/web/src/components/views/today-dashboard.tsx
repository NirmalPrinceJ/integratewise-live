...
export function TodayDashboard({ tasks, events, insights }: TodayDashboardProps) {
    ...
    const suggestions = latestInsight.key_actions || []
    ...
    return (
        <DashboardLayout title="Today" description="Your daily overview and priorities" stageId="TODAY-011">
            ...
            <div className="grid grid-cols-4 gap-4 mb-6">
                <StatCard title="Tasks Due" value={String(todaysTasks.length)} icon={CheckSquare} primary />
                <StatCard title="Meetings" value={String(todaysEvents.length)} icon={Calendar} />
                <StatCard title="AI Suggestions" value={String(suggestions.length)} icon={Zap} />
                <StatCard title="Focus Time" value="4h" icon={Clock} />
            </div>
