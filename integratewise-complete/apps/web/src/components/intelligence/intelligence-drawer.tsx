...
const agents = [
  { id: "forecast", name: "Revenue Forecasting", icon: "📊", status: "active" as const, lastRun: "5 min ago", successRate: 94, actionsThisWeek: 12, modules: ["ops", "sales", "revops"] },
  { id: "churn", name: "ChurnShield", icon: "🔍", status: "active" as const, lastRun: "15 min ago", successRate: 89, actionsThisWeek: 8, modules: ["ops", "sales", "marketing", "cs"] },
  { id: "quality", name: "Data Quality Auditor", icon: "🔬", status: "learning" as const, lastRun: "1h ago", successRate: 78, actionsThisWeek: 24, modules: ["ops"] },
  { id: "nba", name: "Next Best Action", icon: "🎯", status: "active" as const, lastRun: "2 min ago", successRate: 91, actionsThisWeek: 18, modules: ["sales", "marketing", "cs"] },
  { id: "sentiment", name: "Email Sentiment", icon: "📧", status: "active" as const, lastRun: "30 min ago", successRate: 86, actionsThisWeek: 45, modules: ["sales", "marketing"] },
  { id: "anomaly", name: "Anomaly Detector", icon: "🔔", status: "attention" as const, lastRun: "2h ago", successRate: 72, actionsThisWeek: 3, modules: ["ops", "website"] },
  { id: "architect", name: "ArchitectIQ", icon: "🏗️", status: "active" as const, lastRun: "45 min ago", successRate: 88, actionsThisWeek: 6, modules: ["website"] },
  { id: "template", name: "TemplateForge", icon: "✨", status: "active" as const, lastRun: "10 min ago", successRate: 93, actionsThisWeek: 15, modules: ["website", "marketing"] },
  { id: "success", name: "SuccessPilot", icon: "🧭", status: "active" as const, lastRun: "8 min ago", successRate: 90, actionsThisWeek: 22, modules: ["sales", "cs"] },
  { id: "dealdesk", name: "DealDesk AI", icon: "💼", status: "paused" as const, lastRun: "3d ago", successRate: 85, actionsThisWeek: 0, modules: ["sales"] },
]
...
export function IntelligenceDrawer({ isOpen, activeModule, onClose }: IntelligenceDrawerProps) {
  ...
  const relevantAgents = agents.filter((a) => a.modules.includes(moduleKey))
...
function AgentsTabView({ agents: agentList }: { agents: typeof agents }) {
  return (
