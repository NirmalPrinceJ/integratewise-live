...
import { signUp, signInWithMicrosoft, signInWithProvider } from "@/lib/auth-client"
...
export default function SignUpPage() {
  ...
  const handleProviderSignUp = async (provider: "google" | "microsoft" | "github" | "azure") => {
  ...
  return (
    <div className="flex min-h-screen">
      ...
      <div className="hidden lg:flex lg:w-1/2 bg-gradient-to-br from-[#3F3182] via-[#5B4B9A] to-[#E94B8A] p-12 flex-col justify-between relative overflow-hidden">
        ...
        <div className="relative z-10">
          ...
          <h1 className="text-4xl font-bold text-white mb-4 leading-tight">
            Join thousands of teams building better
          </h1>
          <p className="text-white/80 text-lg leading-relaxed">
            Start your journey with IntegrateWise OS. Connect your tools, automate workflows, and supercharge your
            productivity.
          </p>
        </div>
        <div className="relative z-10 space-y-4">
          <div className="flex items-start gap-3">
            ...
            <div>
              ...
              <div className="text-white/70 text-sm">Start with our free plan, upgrade when you're ready</div>
            </div>
          </div>
          <div className="flex items-start gap-3">
            <div className="h-8 w-8 rounded-lg bg-white/10 backdrop-blur-sm flex items-center justify-center flex-shrink-0">
            ...
            <div>
              ...
              <div className="text-white/70 text-sm">No long-term contracts or commitments</div>
            </div>
          </div>
        </div>
      </div>
