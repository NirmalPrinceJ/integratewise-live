...
import type { SpineOrganization, SpinePerson, SpineDeal, SpineTicket, SpineEvent } from '../spine/types';
import type { BrainstormSession, BrainstormAction, BrainstormInsight } from '../brainstorm/types';
