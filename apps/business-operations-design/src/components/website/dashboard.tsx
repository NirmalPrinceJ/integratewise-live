...
export function WebsiteDashboard() {
  const { data: projection, loading, error } = useHydrateProjection<WebsiteProjection>("website");
    ...
    return (
      <div className="flex items-center justify-center h-full">
        <div className="text-center space-y-2">
          ...
          <p className="text-sm text-muted-foreground">Unable to load website data.</p>
          <p className="text-xs text-muted-foreground">Using demo mode.</p>
