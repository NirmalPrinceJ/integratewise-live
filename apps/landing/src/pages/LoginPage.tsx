...
import { Eye, EyeOff, Mail, Lock, ArrowRight, Cpu } from 'lucide-react';
        ...
        <div className="max-w-md w-full mx-auto">
            ...
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-2">
                <Checkbox
                  ...
                  className="border-white/20 data-[state=checked]:bg-iw-accent data-[state=checked]:border-iw-accent"
                />
                <Label htmlFor="remember" className="text-sm text-iw-text-secondary cursor-pointer">
                  Remember me
                </Label>
              </div>
              <Link
                to="/forgot-password"
                className="text-sm text-iw-accent hover:text-iw-accent/80"
              >
                Forgot password?
              </Link>
            </div>
          ...
          <div className="relative my-8">
            ...
            <div className="relative flex justify-center">
              <span className="px-4 bg-iw-bg text-xs text-iw-text-secondary uppercase tracking-wider">
                Or continue with
              </span>
            </div>
          </div>
          ...
          <div className="grid grid-cols-2 gap-4">
            <Button
              variant="outline"
              className="border-white/10 text-iw-text hover:bg-white/5"
            >
          ...
          <p className="mt-8 text-center text-iw-text-secondary">
            ...
            <Link to="/signup" className="text-iw-accent hover:text-iw-accent/80 font-medium">
              Sign up
            </Link>
          </p>
        </div>
        ...
        <div className="relative z-10 flex flex-col justify-center px-12">
          <div className="max-w-md">
            ...
            <h2 className="font-display font-bold text-3xl text-iw-text mb-4">
              "Stop being the cable between your own tools."
            </h2>
            <p className="text-iw-text-secondary leading-relaxed">
              Join thousands of teams who've unified their stack. From the weaver in Jaipur 
              to the engineer in Bangalore—one architecture, one truth, one calm.
            </p>

            {/* Stats */}
            <div className="mt-8 grid grid-cols-3 gap-6">
              <div>
                <div className="font-display font-bold text-2xl text-iw-accent">40%</div>
                <div className="text-xs text-iw-text-secondary">Less context switching</div>
              </div>
              <div>
                <div className="font-display font-bold text-2xl text-iw-accent">60%</div>
                <div className="text-xs text-iw-text-secondary">Faster decisions</div>
              </div>
              <div>
                <div className="font-display font-bold text-2xl text-iw-accent">100%</div>
                <div className="text-xs text-iw-text-secondary">Audit trail</div>
              </div>
            </div>
          </div>
        </div>
