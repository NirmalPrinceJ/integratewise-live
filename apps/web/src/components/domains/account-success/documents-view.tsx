  ...
  return (
    <div className="h-full flex flex-col overflow-hidden">
      ...
      <div className="flex-1 overflow-y-auto p-6">
        {filtered.length === 0 ? (
          <EmptyState
            variant={search || spaceFilter !== "all" ? "no-results" : "no-documents"}
            ctaLabel={search || spaceFilter !== "all" ? undefined : "Upload Document"}
            onAction={search || spaceFilter !== "all" ? undefined : () => console.log("Upload")}
          />
