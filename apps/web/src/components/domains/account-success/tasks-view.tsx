  ...
  return (
    <div className="h-full flex flex-col overflow-hidden">
      ...
      <div className="flex-1 overflow-y-auto p-6 space-y-6">
        {sortedKeys.length === 0 ? (
          <EmptyState
            variant={search || statusFilter !== "all" || priorityFilter !== "all" ? "no-results" : "no-tasks"}
            ctaLabel={search || statusFilter !== "all" || priorityFilter !== "all" ? undefined : "New Task"}
            onAction={search || statusFilter !== "all" || priorityFilter !== "all" ? undefined : () => console.log("Create task")}
          />
        ) : (
