        ...
        <div className="flex-1 min-w-0">
          ...
          <div className="flex items-center gap-3">
            ...
            <div className="flex items-center gap-2 ml-auto">
              {m.hasNotes && <FileText className="w-3.5 h-3.5 text-muted-foreground" />}
              {m.hasRecording && <Video className="w-3.5 h-3.5 text-muted-foreground" />}
              {m.followUpTasks && m.followUpTasks > 0 && (
