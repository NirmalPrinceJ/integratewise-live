...
export function LoginPage({ onLogin = () => {}, onSignUp = () => {}, onForgotPassword = () => {}, onGoogleLogin, onGitHubLogin, error, loading, googleLoading, githubLoading }: LoginPageProps) {
      ...
      <div className="hidden lg:flex lg:w-[480px] xl:w-[520px] bg-gradient-to-br from-[#0C1222] to-[#131B2E] flex-col justify-between p-10 relative overflow-hidden">
        ...
        <div className="relative z-10 space-y-6">
          <h2 className="text-3xl font-extrabold text-white leading-tight">
            Unify your tools.<br />
            <span className="text-[#10B981]">Amplify your growth.</span>
          </h2>
          ...
          <div className="flex items-center gap-2 mt-8">
            <span className="text-[10px] text-white/50 uppercase font-bold tracking-wider">Connects with</span>
        ...
        >
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full bg-slate-50 border border-slate-200 rounded-xl pl-10 pr-4 py-2.5 text-sm outline-none focus:ring-2 focus:ring-emerald-500/20 focus:border-emerald-500 transition-all text-slate-900"
                  required
                />
              </div>
            </div>
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full bg-slate-50 border border-slate-200 rounded-xl pl-10 pr-10 py-2.5 text-sm outline-none focus:ring-2 focus:ring-emerald-500/20 focus:border-emerald-500 transition-all text-slate-900"
                  required
                />
                <button
                  type="button"
            ...
            <div className="flex justify-end">
              <button type="button" onClick={() => { onForgotPassword(); setForgotMessage(true); }} className="text-xs text-[#059669] font-medium hover:underline">
                Forgot password?
              </button>
            </div>
            ...
            {forgotMessage && (
              <div className="bg-emerald-50 border border-emerald-200 rounded-lg px-3 py-2 text-xs text-emerald-700 flex items-center justify-between">
                <span>Password reset link will be sent to your email.</span>
                <button type="button" onClick={() => setForgotMessage(false)} className="text-emerald-500 hover:text-emerald-700 ml-2 font-bold">&times;</button>
              </div>
            )}
          ...
          <p className="text-center text-sm text-slate-500 mt-6">
            ...
            <button onClick={onSignUp} className="text-[#059669] font-semibold hover:underline">
              Start free trial
            </button>
          </p>
        </motion.div>
