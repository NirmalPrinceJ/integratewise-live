    ...
    <ScrollArea className="h-full">
      <div className="p-6 md:p-8 max-w-5xl mx-auto space-y-6">
        ...
        <Card className="border shadow-sm overflow-hidden">
          <div className="h-20 bg-gradient-to-r from-sky-500 to-teal-500" />
          <CardContent className="p-6 -mt-10">
            <div className="flex items-end gap-4 mb-4">
              <div className="w-20 h-20 rounded-2xl bg-sky-500 flex items-center justify-center text-white text-2xl font-bold border-4 border-card shadow-lg">
              ...
              <div className="flex-1 pb-1">
                ...
                <div className="flex items-center gap-2 mt-0.5">
                  <Badge className="bg-sky-500/10 text-sky-500 border-0 text-[10px]">{spine.role || "Admin"}</Badge>
        ...
        <div>
          <div className="flex items-center justify-between mb-4">
            ...
            <Button
              ...
              size="sm"
              className={`text-xs h-8 gap-1 ${editMode ? "bg-sky-500" : ""}`}
            >
            ...
            <div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-2">
                {availableSections.map(section => {
                  const cat = CATEGORY_LABELS[section.category];
                  return (
                    <Card key={section.id} className="border border-dashed shadow-none hover:border-sky-500/30 hover:shadow-sm transition-all cursor-pointer" onClick={() => toggleSection(section.id)}>
                      <CardContent className="p-3 flex items-center gap-3">
