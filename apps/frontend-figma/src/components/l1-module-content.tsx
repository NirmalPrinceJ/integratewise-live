...
import { useDomainTable, useSpineReadiness } from "./spine/spine-client";
...
export function L1ModuleContent({ module, activeCtx }: L1ModuleContentProps) {
  ...
  const { data: projection, loading: pLoading } = useHydrateProjection(activeCtx.replace("CTX_", "").toLowerCase());
