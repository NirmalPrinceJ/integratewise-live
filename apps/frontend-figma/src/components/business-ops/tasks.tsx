...
export function TasksView() {
  ...
  return (
    <div className="p-6 space-y-6 overflow-y-auto h-full">
      ...
      {filtered.length === 0 ? (
        <EmptyState
          variant={searchQuery || priorityFilter !== "all" ? "no-results" : "no-tasks"}
          ctaLabel={searchQuery || priorityFilter !== "all" ? undefined : "Create Task"}
          onAction={searchQuery || priorityFilter !== "all" ? undefined : () => console.log("Create task")}
        />
      ) : viewMode === "list" ? (
