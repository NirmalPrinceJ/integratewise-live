    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <h3 className="font-bold text-slate-800 flex items-center gap-2">
          <ShieldAlert className="text-[#F54476]" size={20} />
      ...
      {unresolvedCount > 0 && (
        <div className="p-5 bg-[#1E2A4A] rounded-2xl text-white">
          ...
          <button
            ...
            className="w-full py-2.5 bg-[#F54476] hover:bg-[#E03A66] rounded-xl text-sm font-bold transition-all shadow-xl shadow-black/20"
          >
